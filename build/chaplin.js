...
define('lib/create_mediator',['underscore', 'backbone', './support'], function(_, Backbone, support) {
...
define('lib/route',['underscore', 'mediator'], function(_, mediator) {
...
define('lib/subscriber',['mediator'], function(mediator) {
...
define('lib/router',['underscore', 'backbone', 'mediator', './subscriber', './route'], function(_, Backbone, mediator, Subscriber, Route) {
...
define('lib/sync_machine',[],function() {
...
define('lib/utils',['jquery', 'underscore', 'mediator'], function($, _, mediator) {
...
define('controllers/application_controller',['underscore', 'mediator', '../lib/utils', '../lib/subscriber'], function(_, mediator, utils, Subscriber) {
...
define('controllers/controller',['underscore', '../lib/subscriber'], function(_, Subscriber) {
...
define('models/model',['underscore', 'backbone', '../lib/subscriber'], function(_, Backbone, Subscriber) {
...
define('models/collection',['underscore', 'backbone', '../lib/subscriber', '../lib/sync_machine', './model'], function(_, Backbone, Subscriber, SyncMachine, Model) {
...
define('views/application_view',['jquery', 'underscore', 'mediator', '../lib/utils', '../lib/subscriber'], function($, _, mediator, utils, Subscriber) {
...
define('application',['mediator', './controllers/application_controller', './views/application_view', './lib/router'], function(mediator, ApplicationController, ApplicationView, Router) {
...
define('views/view',['jquery', 'underscore', 'backbone', '../lib/utils', '../lib/subscriber'], function($, _, Backbone, utils, Subscriber) {
...
define('views/collection_view',['jquery', 'underscore', './view'], function($, _, View) {
